...
** 	
********************************************************************************/
#define SWITCH_PROC(a_in, b_in, c_in, d_in, e_in, f_in, g_in, h_in, 	\
				a_out, b_out, c_out)				\
{							\
	UCHAR ucret = SWITCH_Evaluate(a_in, b_in, c_in, d_in, e_in, f_in, g_in, h_in);	\
	switch (ucret % 4) {	\
	case 0:	\
		a_out = 0;	\
		b_out = 0;	\
...
UCHAR   SWITCH_Evaluate( UCHAR s0, UCHAR s1, UCHAR s2, UCHAR s3, UCHAR s4, UCHAR s5, UCHAR s6, UCHAR s7 );
